import { initializeApp } from "https://www.gstatic.com/firebasejs/10.8.0/firebase-app.js";
        ...
        // Function to fetch and display science fiction books
        async function displayScienceFictionBooks() {
            ...
            try {
                // Reference to the "ScienceFiction" collection in Firestore
                const scienceFictionCollection = collection(db, "ScienceFiction");

                // Get all documents in the "ScienceFiction" collection
                const querySnapshot = await getDocs(scienceFictionCollection);
                ...
                console.error("Error getting science fiction books: ", error);
            }
        }
        ...
        // Call the function to display science fiction books when the page loads
        document.addEventListener("DOMContentLoaded", displayScienceFictionBooks);