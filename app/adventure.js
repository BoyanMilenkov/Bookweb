import { initializeApp } from "https://www.gstatic.com/firebasejs/10.8.0/firebase-app.js";
        ...
        // Function to fetch and display adventure books
        async function displayAdventureBooks() {
            ...
            try {
                // Reference to the "Adventure" collection in Firestore
                const adventureCollection = collection(db, "Adventure");

                // Get all documents in the "Adventure" collection
                const querySnapshot = await getDocs(adventureCollection);
                ...
                console.error("Error getting adventure books: ", error);
            }
        }
        ...
        // Call the function to display adventure books when the page loads
        document.addEventListener("DOMContentLoaded", displayAdventureBooks);