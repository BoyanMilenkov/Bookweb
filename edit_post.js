...
document
  ...
  .addEventListener("submit", submitEditedPost);
...
window.addEventListener("DOMContentLoaded", async () => {
  ...
  onAuthStateChanged(auth, async (user) => {
    if (!user) {
      ...
      // Update header container with authentication status
      const headerContainer = document.getElementById("headerContainer");
      headerContainer.innerHTML = updateHeader(user); // Call updateHeader function
