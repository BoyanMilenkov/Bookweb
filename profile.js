...
onAuthStateChanged(auth, async (user) => {
  ...
  headerContainer.innerHTML = updateHeader(user); // Update header container based on authentication state
      ...
      for (const postId in userPosts) {
        if (Object.hasOwnProperty.call(userPosts, postId)) {
          ...
          const postHTML = `
                    ...
                    `;
          document
            .getElementById("userPostsContainer")
