import { initializeApp } from "https://www.gstatic.com/firebasejs/10.8.0/firebase-app.js";
        ...
        // Function to fetch and display historical books
        async function displayHistoricalBooks() {
            ...
            try {
                // Reference to the "Historical" collection in Firestore
                const historicalCollection = collection(db, "Historical");

                // Get all documents in the "Historical" collection
                const querySnapshot = await getDocs(historicalCollection);
                ...
                console.error("Error getting historical books: ", error);
            }
        }
        ...
        // Call the function to display historical books when the page loads
        document.addEventListener("DOMContentLoaded", displayHistoricalBooks);