import { initializeApp } from "https://www.gstatic.com/firebasejs/10.8.0/firebase-app.js";
        ...
        // Function to fetch and display memoir and biography books
        async function displayMemoirAndBiographyBooks() {
            ...
            try {
                // Reference to the "Memoir and Biography" collection in Firestore
                const memoirAndBiographyCollection = collection(db, "Memoir and Biography");

                // Get all documents in the "Memoir and Biography" collection
                const querySnapshot = await getDocs(memoirAndBiographyCollection);
                ...
                console.error("Error getting memoir and biography books: ", error);
            }
        }
        ...
        // Call the function to display memoir and biography books when the page loads
        document.addEventListener("DOMContentLoaded", displayMemoirAndBiographyBooks);