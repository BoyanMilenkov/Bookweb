...
// Function to fetch and display romance books
async function displayRomanceBooks() {
    ...
    try {
        // Reference to the "Romance" collection in Firestore
        const romanceCollection = collection(db, "Romance");

        // Get all documents in the "Romance" collection
        const querySnapshot = await getDocs(romanceCollection);
...
// Call the function to display romance books when the page loads
document.addEventListener("DOMContentLoaded", displayRomanceBooks);